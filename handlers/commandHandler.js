...
module.exports = async (interaction) => {
    ...
    // ====================================================
    // === /send-message — KIRIM PLAIN TEXT KE CHANNEL ===
    // ====================================================
    ...
    // - Mention divalidasi ketat (sama seperti /announce) supaya admin tidak
    //   bisa oper string bebas yang nggak sengaja nge-ping role/user lain.
