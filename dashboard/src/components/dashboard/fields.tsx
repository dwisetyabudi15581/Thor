...
// Kontrol formulir reusable untuk modul-modul dashboard (ala Dyno).
// Semua field dark-edible (zinc + aksen amber), dipakai berulang oleh
// module-forms.tsx supaya 12 modul tidak menulis UI dari nol.
...
export function ChannelSelect({
  value, onChange, channels, placeholder = "— tidak diset —",
}: {
  value: string | null;
...
export function RoleSelect({
  value, onChange, roles, placeholder = "— tidak diset —",
}: {
  value: string | null;
  onChange: (v: string | null) => void;
  roles: BotRole[];
...
/** Nama channel dari meta berdasarkan id (fallback singkat). */
...
/** Nama role dari meta berdasarkan id. */
