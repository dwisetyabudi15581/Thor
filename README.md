...
> **v3.9.41** · 82 slash command · 433 unit test · discord.js v14 · Node.js 18+ · single-guild
>
...
├── tests/unit/                   # 433 unit test (node:test)
...
| `npm test`       | Jalankan semua unit test (433 test)    |
