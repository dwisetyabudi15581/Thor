...
// Original file sudah dipindahkan ke src/infra/auditLog.js.
// Shim ini tetap dipertahankan untuk backward compatibility dengan code
// yang masih require('../utils/auditLog'). Akan dihapus setelah semua
// caller di-update ke path baru.
module.exports = require('../src/infra/auditLog');
