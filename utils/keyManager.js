...
// Original file sudah dipindahkan ke src/data/keyManager.js.
// Shim ini tetap dipertahankan untuk backward compatibility dengan code
// yang masih require('../utils/keyManager'). Akan dihapus setelah semua
// caller di-update ke path baru.
module.exports = require('../src/data/keyManager');
