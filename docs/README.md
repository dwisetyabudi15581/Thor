...
Kumpulan dokumen resmi untuk **Thor — All-in-One Discord Community Bot** (v3.9.42).
...
| [CHANGELOG.md](../CHANGELOG.md)    | Riwayat lengkap semua versi (v3.9.0 – v3.9.42)                                                                                                 |
...
- **436 unit test** — `node:test`, sandbox (aman dijalankan di server live)
