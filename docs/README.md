...
Kumpulan dokumen resmi untuk **Thor — All-in-One Discord Community Bot** (v3.19.0).
...
| [CHANGELOG.md](../CHANGELOG.md)    | Riwayat lengkap semua versi (v3.9.0 – v3.19.0)                                                                                                 |
| [../DEPLOY.md](../DEPLOY.md)       | Panduan deploy SATU repo: VPS + pm2 + domain/HTTPS + OAuth + verifikasi end-to-end                                                             |
| [../dashboard/](../dashboard/)     | Dashboard web ala Dyno (Next.js) — dokumentasi & cara menjalankan ada di `dashboard/README.md`                                                  |
...
- **93 slash command** — semua fitur dapat dikonfigurasi dari Discord ATAU web dashboard, tanpa edit file
- **670 unit test** — `node:test`, sandbox (aman dijalankan di server live)
