...
Kumpulan dokumen resmi untuk **Thor — All-in-One Discord Community Bot** (v3.14.0).
...
| [CHANGELOG.md](../CHANGELOG.md)    | Riwayat lengkap semua versi (v3.9.0 – v3.14.0)                                                                                                 |
...
- **93 slash command** — semua fitur dapat dikonfigurasi dari Discord, tanpa edit file
