...
const COMMAND_TO_DOMAIN = {
    ...
    'edit-message': 'config',
    // v3.9.48: diagnosis welcome/goodbye + preview langsung
    'test-welcome': 'config',
...
// Ini supaya staff moderasi gak harus dikasih role admin bot cuma buat
// mute/kick — prinsip least privilege.
