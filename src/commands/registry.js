...
function getCommands() {
    return [
        // === PREMIUM (v3.15.0 — langganan per-server ala Dyno) ===
        // Tanpa defaultMemberPermissions: /premium status publik untuk semua
        // member; activate di-guard permission ManageGuild di handler; gen/
        // keys/revoke khusus pemilik bot (PREMIUM_ADMIN_IDS).
        {
            name: 'premium',
            description: 'Kelola langganan Thor Premium server (status, aktivasi key)',
            options: [
                {
                    type: 1,
                    name: 'status',
                    description: 'Lihat status langganan Premium server ini + apa saja yang gratis vs premium',
                    required: false
                },
                {
                    type: 1,
                    name: 'activate',
                    description: 'Aktifkan langganan Premium dengan key (khusus admin server)',
                    required: false,
                    options: [
                        {
                            type: 3,
                            name: 'key',
                            description: 'Key premium (format XXXXX-XXXXX-XXXXX)',
                            required: true,
                            max_length: 17
                        }
                    ]
                },
                {
                    type: 1,
                    name: 'gen',
                    description: 'Buat key premium baru (khusus pemilik bot)',
                    required: false,
                    options: [
                        {
                            type: 3,
                            name: 'plan',
                            description: 'Paket langganan',
                            required: true,
                            choices: [
                                { name: 'Premium 30 Hari', value: 'premium30' },
                                { name: 'Premium 90 Hari', value: 'premium90' },
                        ...
                        },
                        {
                            type: 3,
                            name: 'note',
                            description: 'Catatan internal (opsional, maks 60 char)',
                            required: false,
                            max_length: 60
                        }
                    ]
                },
                {
                    type: 1,
                    name: 'keys',
                    description: 'Lihat stok key lokal + server berlangganan (khusus pemilik bot)',
                    required: false
                },
                {
                    type: 1,
                    name: 'revoke',
                    description: 'Cabut langganan sebuah server — kasus refund (khusus pemilik bot)',
                    required: false,
                    options: [
                        {
                            type: 3,
                            name: 'guild',
                            description: 'Guild id target (kosong = server tempat command ini dijalankan)',
                            required: false,
                            max_length: 25
                        }
                    ]
        ...
        // === MANAJEMEN PRODUK ===
        {
            ...
            options: [
                ...
                { type: 3, name: 'value', description: 'ID unik (mis. 7d)', required: true },
                {
                    type: 3,
                    name: 'price',
                    description: 'Harga (mis. Rp 50.000 / $3 / $2.50 / 5.88 / 25rb — maks 100 char)',
                    required: true,
                    max_length: 100
                },
                {
        ...
        // value TIDAK bisa diubah (dipakai sebagai customId di modal_set_key).
        {
            ...
            options: [
                ...
                },
                {
                    type: 3,
                    name: 'price',
                    description: 'Harga baru (mis. "Rp 25.000" / "$3" / "$2.50" / "5.88")',
                    required: false,
                    min_length: 1,
                    max_length: 100
                },
