...
module.exports = async function (interaction) {
    const helpEmbed = new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: '💬 Auto-Responder (v3.9.13 BARU)', value: [
            ...
            { name: '🛡️ Anti-Spam & Auto-Mod (v3.9.13 BARU)', value: [
            ...
            { name: '💤 AFK System (v3.9.13 BARU)', value: [
            ...
            { name: '📊 Leveling System (v3.9.13 BARU)', value: [
        ...
        .setFooter({ text: `${interaction.client.user.username} v3.9.13 — All-in-One Community Bot`, iconURL: interaction.client.user.displayAvatarURL({ dynamic: true }) })
        .setTimestamp();
